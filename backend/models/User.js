...
class User {
  ...
  static async getAll() {
    const query = 'SELECT user_id, username, full_name, email, role, is_active, last_login, created_at FROM users WHERE is_active = true ORDER BY full_name';
  ...
  static async getById(id) {
    const query = 'SELECT user_id, username, full_name, email, role, is_active, last_login, created_at FROM users WHERE user_id = $1';
